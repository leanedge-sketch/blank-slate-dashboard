...
const modules = [
  ...
  },
  {
    ...
    subtitle: "tds_data",
    description: "Technical Data Sheets linked to catalog products",
    href: "/pms/tds",
    cta: "Manage TDS",
  ...
  },
  {
    ...
    subtitle: "partner_data",
    description: "Business partners used for catalog links and pricing/costing",
    href: "/pms/partners",
    cta: "Manage partners",
  ...
  },
  {
    ...
    subtitle: "costing_pricing_data",
    description: "costing_pricing_data — partner × TDS rows: incoterm, cost USD/ETB, price USD/ETB",
    href: "/pms/pricing",
    cta: "Manage pricing",
