...
ALTER TABLE public.sales_pipeline DROP CONSTRAINT IF EXISTS sales_pipeline_currency_check;
ALTER TABLE public.sales_pipeline DROP CONSTRAINT IF EXISTS sales_pipeline_forex_check;
ALTER TABLE public.sales_pipeline DROP CONSTRAINT IF EXISTS sales_pipeline_business_unit_check;
ALTER TABLE public.sales_pipeline DROP CONSTRAINT IF EXISTS sales_pipeline_incoterm_check;
ALTER TABLE public.sales_pipeline DROP CONSTRAINT IF EXISTS sales_pipeline_business_model_check;
...
ALTER TABLE public.sales_pipeline DROP CONSTRAINT IF EXISTS sales_pipeline_closed_requires_reason;

ALTER TABLE public.sales_pipeline
ADD CONSTRAINT sales_pipeline_closed_requires_reason
CHECK (
    stage <> 'Closed'
...
-- -----------------------------------------------------------------------------
ALTER TABLE public.stock_movements DROP CONSTRAINT IF EXISTS stock_movements_location_check;
ALTER TABLE public.stock_movements DROP CONSTRAINT IF EXISTS stock_movements_transfer_to_location_check;
...
ALTER TABLE public.stock_movements DROP CONSTRAINT IF EXISTS stock_movements_business_model_check;
...
CHECK (
    transfer_to_location IS NULL
    OR transfer_to_location IN ('addis_ababa','sez_kenya','nairobi_partner')
) NOT VALID;
...
ALTER TABLE public.stock_movements DROP CONSTRAINT IF EXISTS stock_movements_transfer_requires_destination;

ALTER TABLE public.stock_movements
ADD CONSTRAINT stock_movements_transfer_requires_destination
CHECK (
...
ALTER TABLE public.customers DROP CONSTRAINT IF EXISTS customers_sales_stage_check;
