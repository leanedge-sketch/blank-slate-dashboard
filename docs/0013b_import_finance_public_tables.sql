...
CREATE TABLE IF NOT EXISTS public.import_finance_shipments (
  ...
  snapshot_base_customs_reference_usd numeric,
  target_selling_price_etb_per_kg numeric,
  material_cost_usd_per_kg numeric,
  border_value_usd_per_kg numeric,
  capital_outlay_etb numeric,
  cif_assessed_usd_per_kg numeric,
  cif_base_etb numeric,
  duty_etb numeric,
  scan_fee_etb numeric,
  social_fee_etb numeric,
  wht_etb numeric,
  vat_etb numeric,
  total_customs_paid_etb numeric,
  inland_transport_etb numeric,
  gross_investment_etb numeric,
  net_landed_cost_etb numeric,
  final_landed_unit_cost_etb_per_kg numeric,
  profit_per_kg_etb numeric,
  gross_margin_pct numeric,
  total_expected_revenue_etb numeric,
